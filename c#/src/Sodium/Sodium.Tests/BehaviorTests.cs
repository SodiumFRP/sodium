...
namespace Sodium.Tests
{
    ...
    public class BehaviorTests
    {
        ...
        public void TestSwitchSSimultaneous()
        {
            ...
            Stream<int> so = bss.Map<Stream<int>>(b => b.S).SwitchS();
            List<int> @out = new List<int>();
            IListener l = so.Listen(@out.Add);
            Ss2 ss2 = new Ss2();
            Ss2 ss3 = new Ss2();
        ...
        public void TestLiftInSwitchC()
        {
            ...
            Behavior<IReadOnlyList<int>> c = v.Map(oo => oo.Select(o => o.Value).Lift()).SwitchC();
        ...
        public void TestMapWithSwitchC()
        {
            ...
            Behavior<IReadOnlyList<int>> c = v.Map(oo => oo.Select(o => o.Value).Lift()).Map(o => o).SwitchC();
