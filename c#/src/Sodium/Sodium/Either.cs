...
namespace Sodium
{
    ...
    public struct Either<T1, T2, T3, T4, T5, T6> : IEither
    {
        ...
        public static implicit operator Either<T1, T2, T3, T4, T5, T6>(Either.EitherSecond<T2> value) => Second(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6>(Either.EitherThird<T3> value) => Third(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6>(Either.EitherFourth<T4> value) => Fourth(value.Value);
    ...
    public struct Either<T1, T2, T3, T4, T5, T6, T7> : IEither
    {
        ...
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7>(Either.EitherFirst<T1> value) => First(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7>(Either.EitherSecond<T2> value) => Second(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7>(Either.EitherThird<T3> value) => Third(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7>(Either.EitherFourth<T4> value) => Fourth(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7>(Either.EitherFifth<T5> value) => Fifth(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7>(Either.EitherSixth<T6> value) => Sixth(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7>(Either.EitherSeventh<T7> value) => Seventh(value.Value);
    ...
    public struct Either<T1, T2, T3, T4, T5, T6, T7, T8> : IEither
    {
        ...
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7, T8>(Either.EitherFirst<T1> value) => First(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7, T8>(Either.EitherSecond<T2> value) => Second(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7, T8>(Either.EitherThird<T3> value) => Third(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7, T8>(Either.EitherFourth<T4> value) => Fourth(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7, T8>(Either.EitherFifth<T5> value) => Fifth(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7, T8>(Either.EitherSixth<T6> value) => Sixth(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7, T8>(Either.EitherSeventh<T7> value) => Seventh(value.Value);
        public static implicit operator Either<T1, T2, T3, T4, T5, T6, T7, T8>(Either.EitherEighth<T8> value) => Eighth(value.Value);
