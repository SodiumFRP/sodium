public class LazyExtensionMethods
{
    /// <summary>
    ...
    {
        return Lazy<TResult>(() => f(a.Value, b.Value))
    }
    ...
    {
        return Lazy<TResult>(() => f(a.Value, b.Value, c.Value))
    }
    ...
    {
        return Lazy<TResult>(() => f(a.Value, b.Value, c.Value, d.Value))
    }
}
